...
from Self_CovTabNet import NET
...
@dataclass
class Self_CovTabModel(BaseEstimator):
    ...
    optimizer_params: Dict = field(default_factory=lambda: dict(lr=0.01))
    ...
    def fit(
        ...
        for epoch_idx in range(self.max_epochs):
            ...
            data = self.history.epoch_loss

            # Call method on_epoch_end for all callbacks
            self._callback_container.on_epoch_end(
                epoch_idx, data, logs=self.history.epoch_metrics
            )
